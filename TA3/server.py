...
def handle_client(player_socket,player_name):
    ...
    # Get player_type from CLIENTS[player_name] in player_type variable
    
    # If player type is player 1 then set turn to True otherwise false.
    
    

    # Send the message "player_type' : current player type , 'turn': current player's turn '
